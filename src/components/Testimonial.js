  ...
  return (
    <section className="max-w-[1246px] mx-[auto] mt-[160px] ">
      ...
      >
        ...
        <div className="max-w-[759px] mx-[auto] px-[56px] pb-[45px] pt-[64px] rounded-[24px] bg-white shadow-testimonialShadow mt-[96px] relative">
          <img
            src={photo}
            alt="img"
            className="w-[80px] left-[50%] translate-x-[-50%] top-[-30px] absolute shadow-testimonialShadow2"
          />
