  ...
  return (
    <section className=" cursor-pointer">
      {height ? (
        ...
        <div className={` group bg-pricingFeeBg pb-[32px] w-fit ${rounded}`}>
          <div className="head-wrapper px-[32px] pt-[32px] group-hover:bg-pricinghoverbg group-hover:rounded-t-[16px]">
            <div className="flex gap-[16px] items-center mb-[24px]">
              <div>{icon}</div>
              <div>
                <p className="text-pricingFeeText1 leading-[20px]">For</p>
          ...
          <div className="px-[32px]">
            ...
            <div className="flex items-center justify-between py-[12px] pl-[24px] pr-[17px] bg-white rounded-[1000px] border-2 border-pricingFeeborder mt-[42px] group-hover:bg-secondary ">
              <p className="text-base group-hover:text-white">Get Started</p>
              <svg
                width="79"
                height="14"
